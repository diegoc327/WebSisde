...
<body>
	...
	<div class="contact">
	<div class="container">			
			<h3><span>Buscar Tipo de Comercializacion</span></h3>
			<p class="autem">"Aui una pequeña descripcon"</p>
			<div class="contact-grids">
				<div class="contact-grid">
					<div class="col-md-6 contact-grid-center">
						<form action="#" method="post">
							<input type="text" value="Ambito" name="Ambito" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Buscar Tipo de...';}" required="">
